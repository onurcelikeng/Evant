...
namespace Evant.DAL.Migrations
{
    ...
    [Migration("20180524205428_Weather Entity")]
    partial class WeatherEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Evant.DAL.EF.Tables.UserSetting", b =>
                {
                    ...
                    b.Property<bool>("IsCommentVisibleTimeline");

                    b.Property<bool>("IsCreateEventVisibleTimeline");
                    ...
                    b.Property<bool>("IsFollowerVisibleTimeline");

                    b.Property<bool>("IsFollowingVisibleTimeline");
            ...
            modelBuilder.Entity("Evant.DAL.EF.Tables.Weather", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Evant.DAL.EF.Tables.Notification", b =>
                {
                    b.HasOne("Evant.DAL.EF.Tables.Comment", "Comment")
                        .WithMany("Comment_Notifications")
                        .HasForeignKey("CommentId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Evant.DAL.EF.Tables.Event", "Event")
                        .WithMany("Event_Notifications")
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Evant.DAL.EF.Tables.User", "SenderUser")
                        .WithMany("User_Notifications")
